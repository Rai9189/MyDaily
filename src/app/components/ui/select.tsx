  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        // ✅ FIX: side="bottom" + sideOffset memaksa dropdown selalu ke bawah
        // Tanpa ini Radix akan otomatis pilih arah berdasarkan ruang tersedia,
        // yang kadang salah deteksi dan memilih ke atas
        side="bottom"
        sideOffset={4}
      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            "p-1",
            position === "popper" &&
              // ✅ FIX: Hapus h-[var(--radix-select-trigger-height)] yang membatasi tinggi
              // dan menyebabkan Radix salah kalkulasi ruang tersedia
