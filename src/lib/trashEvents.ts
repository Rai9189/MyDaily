...
const transactionCreatedListeners: Listener[] = [];
...
export const trashEvents = {
  ...
  // Dipanggil setelah AccountContext insert transaksi adjustment
  // agar TransactionContext bisa refresh list tanpa re-render loop
